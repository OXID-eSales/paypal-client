 ...
 *
 * generated from: AddressPortable2_address_details
 */
class AddressPortableTwoAddressDetails implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->street_number) || Assert::maxLength(
            $this->street_number,
            100,
            "street_number in AddressPortableTwoAddressDetails must have maxlength of 100 $within"
        );
        !isset($this->street_name) || Assert::maxLength(
            $this->street_name,
            100,
            "street_name in AddressPortableTwoAddressDetails must have maxlength of 100 $within"
        );
        !isset($this->street_type) || Assert::maxLength(
            $this->street_type,
            100,
            "street_type in AddressPortableTwoAddressDetails must have maxlength of 100 $within"
        );
        !isset($this->delivery_service) || Assert::maxLength(
            $this->delivery_service,
            100,
            "delivery_service in AddressPortableTwoAddressDetails must have maxlength of 100 $within"
        );
        !isset($this->building_name) || Assert::maxLength(
            $this->building_name,
            100,
            "building_name in AddressPortableTwoAddressDetails must have maxlength of 100 $within"
        );
        !isset($this->sub_building) || Assert::maxLength(
            $this->sub_building,
            100,
            "sub_building in AddressPortableTwoAddressDetails must have maxlength of 100 $within"
        );
    }
