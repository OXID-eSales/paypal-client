...
class Name2 implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->prefix) || Assert::maxLength(
            $this->prefix,
            140,
            "prefix in Name2 must have maxlength of 140 $within"
        );
        !isset($this->given_name) || Assert::maxLength(
            $this->given_name,
            140,
            "given_name in Name2 must have maxlength of 140 $within"
        );
        !isset($this->surname) || Assert::maxLength(
            $this->surname,
            140,
            "surname in Name2 must have maxlength of 140 $within"
        );
        !isset($this->middle_name) || Assert::maxLength(
            $this->middle_name,
            140,
            "middle_name in Name2 must have maxlength of 140 $within"
        );
        !isset($this->suffix) || Assert::maxLength(
            $this->suffix,
            140,
            "suffix in Name2 must have maxlength of 140 $within"
        );
