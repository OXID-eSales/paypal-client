...
class Phone2 implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        Assert::notNull($this->country_code, "country_code in Phone2 must not be NULL $within");
        Assert::minLength(
            $this->country_code,
            1,
            "country_code in Phone2 must have minlength of 1 $within"
        );
        Assert::maxLength(
            $this->country_code,
            3,
            "country_code in Phone2 must have maxlength of 3 $within"
        );
        ...
        !isset($this->extension_number) || Assert::minLength(
            ...
            1,
            "extension_number in Phone2 must have minlength of 1 $within"
        );
        !isset($this->extension_number) || Assert::maxLength(
            $this->extension_number,
            15,
            "extension_number in Phone2 must have maxlength of 15 $within"
        );
    }
