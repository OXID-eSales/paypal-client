 ...
 */
class RequestEligibility implements JsonSerializable
{
    use BaseModel;
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->encrypted_transaction_id) || Assert::minLength(
            ...
            1,
            "encrypted_transaction_id in RequestEligibility must have minlength of 1 $within"
        );
        !isset($this->encrypted_transaction_id) || Assert::maxLength(
            $this->encrypted_transaction_id,
            255,
            "encrypted_transaction_id in RequestEligibility must have maxlength of 255 $within"
        );
        !isset($this->dispute_id) || Assert::minLength(
            $this->dispute_id,
            1,
            "dispute_id in RequestEligibility must have minlength of 1 $within"
        );
        !isset($this->dispute_id) || Assert::maxLength(
            $this->dispute_id,
            255,
            "dispute_id in RequestEligibility must have maxlength of 255 $within"
        );
        !isset($this->buyer_note) || Assert::minLength(
            $this->buyer_note,
            1,
            "buyer_note in RequestEligibility must have minlength of 1 $within"
        );
        !isset($this->buyer_note) || Assert::maxLength(
            $this->buyer_note,
            2000,
            "buyer_note in RequestEligibility must have maxlength of 2000 $within"
        );
    }
