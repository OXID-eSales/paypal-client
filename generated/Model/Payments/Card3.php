 ...
 *
 * generated from:
 * customized_x_requiredOverride_57352_customized_x_unsupported_8737_MerchantCommonComponentsSpecification-v1-schema-card.json
 */
class Card3 implements JsonSerializable
{
    ...
    public function validate($from = null)
    {
        ...
        Assert::isInstanceOf(
            ...
            "billing_address in Card3 must be instance of AddressPortable2 $within"
        );
    ...
    {
        $this->billing_address = new AddressPortable2();
        if (isset($data)) {
            $this->map($data);
        }
    }
