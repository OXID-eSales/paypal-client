 ...
 * The product details.
 *
 * generated from: merchant.CommonComponentsSpecification-v1-schema-product.json
 */
class Product implements JsonSerializable
{
    ...
    /**
     * The ID of the product. The ID can be an auto-generated ID or a merchant provided identifier.
     *
     * @var string | null
     * minLength: 6
     * maxLength: 50
    ...
    /**
     * The resource ID of the product. This is an auto-generated ID. Example: PROD-XXXXXXX.
     *
     * @var string | null
     * minLength: 6
     * maxLength: 50
    ...
    public function validate($from = null)
    {
        ...
        !isset($this->product_id) || Assert::minLength(
            $this->product_id,
            6,
            "product_id in Product must have minlength of 6 $within"
        );
        !isset($this->product_id) || Assert::maxLength(
            $this->product_id,
            50,
            "product_id in Product must have maxlength of 50 $within"
        );
        ...
        !isset($this->payee) || Assert::isInstanceOf(
            $this->payee,
            Payee::class,
            "payee in Product must be instance of Payee $within"
        );
        !isset($this->payee) ||  $this->payee->validate(Product::class);
